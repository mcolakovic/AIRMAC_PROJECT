...
namespace KorisnickiInterfejs.GUIController
{
    class ServiceInspenctionController
    {
            ...
            try
            {
                if (!Validation())
                {
                    ...
                    RotablePartsService rotablePartsService = new RotablePartsService
                    {
                        ...
                        NewHoursOperationalLimit = frmServiceInspenction.TxtHoursOperationalLimit.Text == "" ? 0 : Decimal.Parse(frmServiceInspenction.TxtHoursOperationalLimit.Text),
                        NewCyclesOperationalLimit = frmServiceInspenction.TxtCyclesOperationalLimit.Text == "" ? 0 : Decimal.Parse(frmServiceInspenction.TxtCyclesOperationalLimit.Text),
                        NewDaysOperationalLimit = frmServiceInspenction.TxtDaysOperationalLimit.Text == "" ? 0 : Decimal.Parse(frmServiceInspenction.TxtDaysOperationalLimit.Text),
                        NewStorageLimit = frmServiceInspenction.TxtStorageLimit.Text == "" ? 0 : Decimal.Parse(frmServiceInspenction.TxtStorageLimit.Text),
        ...
        private bool Validation()
        {
            ...
            if (frmServiceInspenction.RbNewOperationalLimit.Checked && !decimal.TryParse(frmServiceInspenction.TxtHoursOperationalLimit.Text, out _)) return false;
            if (frmServiceInspenction.RbNewOperationalLimit.Checked && !decimal.TryParse(frmServiceInspenction.TxtCyclesOperationalLimit.Text, out _)) return false;
            if (frmServiceInspenction.RbNewOperationalLimit.Checked && !decimal.TryParse(frmServiceInspenction.TxtDaysOperationalLimit.Text, out _)) return false;
            if (frmServiceInspenction.RbNewOperationalLimit.Checked && !decimal.TryParse(frmServiceInspenction.TxtStorageLimit.Text, out _)) return false;

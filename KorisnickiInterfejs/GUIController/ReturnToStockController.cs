            ...
            try
            {
                RotablePartsLog rotablePartsLog = new RotablePartsLog
                {
                    ...
                    RotablePartsSubClass = new RotablePartsStock
                    {
                        ...
                        HoursOperationalLimit = frmReturnToStock.RbNewOperationalLimit.Checked == true ? decimal.Parse(frmReturnToStock.TxtHoursOperationalLimit.Text) : HOL,
                        CyclesOperationalLimit = frmReturnToStock.RbNewOperationalLimit.Checked == true ? decimal.Parse(frmReturnToStock.TxtCyclesOperationalLimit.Text) :  COL,
                        DaysOperationalLimit = frmReturnToStock.RbNewOperationalLimit.Checked == true ? decimal.Parse(frmReturnToStock.TxtDaysOperationalLimit.Text) :  DOL,
                        StorageLimit = frmReturnToStock.RbNewOperationalLimit.Checked == true ? decimal.Parse(frmReturnToStock.TxtStorageLimit.Text) : SL,
                        TimeSinceNew = TSN,
                        CyclesSinceNew = CSN,
                        DaysSinceNew = DSN,
                        TimeSinceOverhaul = (frmReturnToStock.RbOverhaul.Checked == true || frmReturnToStock.RbNewOperationalLimit.Checked == true) ? 0 : TSO,
                        CyclesSinceOverhaul = (frmReturnToStock.RbOverhaul.Checked == true || frmReturnToStock.RbNewOperationalLimit.Checked == true) ? 0 : CSO,
                        DaysSinceOverhaul = (frmReturnToStock.RbOverhaul.Checked == true || frmReturnToStock.RbNewOperationalLimit.Checked == true) ? 0 : DSO,

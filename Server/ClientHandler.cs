        ...
        private Response CreateResponse(Request request)
        {
            ...
            switch (request.Operation)
            {
                case Operation.GetAircrafts:
                    ...
                    if (((List<Aircraft>)response.ResponseObject).Count > 0)
                    {
                ...
                case Operation.Login:
                    ...
                    else
                    {
                        ...
                        if (user != null)
                        {
                            response.ResponseObject = request.RequestObject;
                            this.user = user;
                            this.User.IPAdresa = socket.RemoteEndPoint.ToString();
                            this.User.VrijemePristupa = DateTime.Now.ToString();
                            response.IsSuccessful = true;
                        ...
                        else
                        {
                            response.ResponseObject = null;
                            response.IsSuccessful = false;
                            response.Message = "Korisnicko ime ne postoji";
                        }
                    }
                   break;
            }
